...
<body style="margin:0;padding:0;background-color:#f5f0e8;font-family:Arial,Helvetica,sans-serif;">
  <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;">
    {{ $clientName }}, your {{ $serviceName }} on {{ $appointmentDate }} at {{ $appointmentTime }} is confirmed. Booking #CB-{{ str_pad($bookingId, 5, '0', STR_PAD_LEFT) }}.
  </div>
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" class="card" style="max-width:600px;width:100%;margin:0 auto;background:#ffffff;border-radius:18px;overflow:hidden;border:1px solid #e9e1d2;">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td class="header-pad" align="center" style="padding:32px 36px 26px;">
                    ...
                    <p style="margin:16px 0 0;display:inline-block;background-color:rgba(52,211,153,0.14);border:1px solid rgba(52,211,153,0.45);border-radius:100px;padding:7px 18px;font-size:11px;font-weight:700;color:#34d399;letter-spacing:0.08em;">BOOKING CONFIRMED</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td class="content-pad" style="padding:34px 36px 30px;background-color:#ffffff;">
              <h1 class="greeting" style="margin:0 0 10px;font-family:Georgia,serif;font-size:24px;font-weight:700;color:#062c22;line-height:1.35;">You're all set, {{ $clientName }}.</h1>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="background-color:#faf8f3;border:1px solid #ece3d0;border-radius:12px;overflow:hidden;margin-bottom:20px;">
                <tr>
                  <td style="padding:6px 20px 4px;font-size:10px;font-weight:700;color:#a08c5b;letter-spacing:0.14em;">CONFIRMED DETAILS</td>
                </tr>
                <tr>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="background-color:#f0f7f3;border-left:4px solid #34d399;border-radius:0 10px 10px 0;margin-bottom:24px;">
                <tr>
          ...
          <tr>
            <td class="footer-pad" align="center" style="background-color:#062c22;padding:24px 36px;">
              <p style="margin:0;font-size:12px;color:rgba(255,255,255,0.55);line-height:1.8;">
                ...
                <span style="color:rgba(255,255,255,0.35);">Show this booking ID at reception.</span>
              </p>
            </td>
          </tr>
        </table>
