  ...
  <style>
    * {
    ...
    .check-icon {
      ...
      height: 20px;
      border-radius: 50%;
      background: linear-gradient(135deg, #0a3d30, #073328);
      color: #34d399;
      display: flex;
      align-items: center;
...
<body>
  <div class="wrapper">
    ...
    <div class="content">
      ...
      <p class="intro">
        Just a friendly reminder that your <strong>{{ $serviceName }}</strong> session is scheduled in
        <strong>{{ $hoursUntil }} hours</strong>. Make sure you're comfortable and ready to relax!
      </p>
