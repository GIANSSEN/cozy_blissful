...
<head>
  ...
  <style>
    * {
    ...
    .header {
      background: linear-gradient(135deg, #041e16 0%, #073328 60%, #0a3d30 100%);
    ...
    .header-line {
      height: 3px;
      background: linear-gradient(90deg, transparent, #bfa15f, #e8cc8a, #bfa15f, transparent);
      margin-bottom: 28px;
    }
    ...
    .logo-circle {
      ...
      height: 68px;
      border-radius: 50%;
      border: 3px solid rgba(191, 161, 95, 0.6);
      margin: 0 auto 14px;
      overflow: hidden;
      box-shadow: 0 0 0 5px rgba(191, 161, 95, 0.12);
    }
    ...
    .booking-card {
      background: linear-gradient(135deg, #041e16, #073328);
      border-radius: 14px;
      padding: 28px;
      margin-bottom: 28px;
      position: relative;
    ...
    .cta-button {
      display: block;
      text-align: center;
      background: linear-gradient(135deg, #bfa15f, #d4b87a, #c8a455);
      color: #041e16;
      font-size: 14px;
      font-weight: 800;
      padding: 16px 32px;
      ...
      margin-bottom: 28px;
      box-shadow: 0 4px 20px rgba(191, 161, 95, 0.35);
    }
    ...
    .divider {
      height: 1px;
      background: linear-gradient(90deg, transparent, rgba(191, 161, 95, 0.2), transparent);
      margin: 28px 0;
    }
  </style>
</head>
...
<body>
  <div class="wrapper">
    ...
    <div class="content">
      ...
      <p class="intro">
        We've received your appointment request and it's currently being reviewed by our team. You'll receive another
        email once it's confirmed. In the meantime, here are your booking details:
      </p>
      ...
      <div class="booking-card">
        ...
        <div class="booking-row">
          ...
          <span class="value"><span
              class="booking-id-tag">#CB-{{ str_pad($bookingId, 5, '0', STR_PAD_LEFT) }}</span></span>
        </div>
        <div class="booking-row">
        ...
        @if($notes)
          <div class="booking-row">
            ...
            <span class="value"
              style="color: rgba(255,255,255,0.6); font-weight: 500; font-size: 12px;">{{ $notes }}</span>
          </div>
        @endif
      </div>
      ...
      <div class="info-box">
        ...
        Our admin team will review and confirm your booking within 30 minutes to 1 hour. Once confirmed, you'll receive
