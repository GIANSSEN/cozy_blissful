...
import { LogIn, Eye, EyeOff, AlertCircle, Clock, Mail, Lock, Sparkles, Info, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="w-full mt-0.5">
      <div className="flex items-center gap-2 my-2">
        ...
        <span className="text-[9px] font-bold tracking-widest uppercase shrink-0" style={{ color: B.inkSoft }}>or continue with</span>
        <div className="flex-1 h-px" style={{ background: B.line }} />
      </div>
...
const Login = () => {
  ...
  const validate = () => {
    ...
    if (!trimmedEmail) e.email = 'Email address is required.';
    else if (!emailRegex.test(trimmedEmail)) e.email = 'Please enter a valid email address.';
  ...
  const handleSubmit = async (ev) => {
    ...
    setSubmitting(true);
    const trimmedEmail = email.trim();
    if (remember) localStorage.setItem('remember_email', trimmedEmail);
    ...
    <div
      ...
      <motion.div
        ...
        style={{
          ...
          /* Responsive height: never taller than the viewport */
        ...
        <div
          ...
          <div className="relative z-10">
            ...
            <h2 className="font-black text-white leading-tight tracking-tight mb-0.5"
              style={{ fontSize: 'clamp(1.25rem, 2.5vw, 1.65rem)' }}>Relax. Recharge.</h2>
            <h3 className="font-bold mb-2" style={{ color: B.goldLight, fontSize: 'clamp(0.85rem, 1.5vw, 1rem)' }}>Spa-Quality At Your Door.</h3>
        ...
        <div
          ...
          <div className="w-full" style={{ maxWidth: 'clamp(280px, 90%, 360px)' }}>
            ...
            <div className="flex flex-col items-center mb-3 text-center">
              ...
              <h1 className="text-base font-black tracking-tight mb-0.5" style={{ color: B.ink }}>Welcome Back!</h1>
              <p className="text-[11px]" style={{ color: B.inkSoft }}>Sign in to your Cozy Blissful account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-2.5">
              <Input label="Email Address" id="login-email" type="email" autoComplete="email" required icon={Mail}
                ...
                onBlur={() => {
                  const t = email.trim();
                  if (!t) setFieldErrors(p => ({ ...p, email: 'Email address is required.' }));
                  else if (!emailRegex.test(t)) setFieldErrors(p => ({ ...p, email: 'Please enter a valid email address.' }));
                }}
              ...
              <div className="flex items-center justify-between text-xs py-0.5">
                <label className="inline-flex items-center gap-1.5 cursor-pointer select-none">
                  ...
                  <span className="font-medium text-[11px]" style={{ color: B.inkSoft }}>Remember me</span>
                </label>
                <Link to="/forgot-password"
                  className="font-semibold text-[11px] transition-colors hover:underline underline-offset-2 shrink-0"
                  style={{ color: B.gold }}>
                  Forgot password?
                </Link>
              </div>
