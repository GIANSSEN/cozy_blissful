        ...
        >
          ...
          >
            ...
            <p className="text-emerald-200/80 text-xs mt-0.5">
              #{String(appointment?.id || 1).padStart(5, '0')} — {appointment?.service}
            </p>
          </div>
          ...
          <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5 no-scrollbar">
            ...
            >
              ...
              <div className="text-right">
                ...
                <p className="text-xs font-semibold text-slate-700 mt-0.5 max-w-[150px] text-right">{appointment?.service}</p>
              </div>
            </div>
          ...
          <div className="px-6 py-4 border-t border-black/5 bg-white/50 backdrop-blur-sm flex gap-3 flex-shrink-0">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 py-2.5 rounded-2xl text-xs font-bold text-slate-500 transition hover:bg-slate-100 cursor-pointer"
            ...
            <button
              ...
              style={{
                ...
                boxShadow: '0 6px 18px rgba(6,44,34,0.28)',
              }}
            >
              {loading ? (
                <>
