      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-4 flex-shrink-0"
          ...
          <button
            ...
            className="flex items-center gap-2.5 min-w-0 flex-1 text-left focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:outline-none rounded-xl p-1 -m-1">
            <div className="w-9 h-9 rounded-2xl overflow-hidden flex-shrink-0"
              style={{ boxShadow: '0 4px 14px rgba(10,61,48,0.35)' }}>
              <img src="/cb-logo.jpg" alt="Cozy Blissful Logo" className="w-full h-full object-cover" />
            </div>
        ...
        <nav className="flex-1 overflow-y-auto px-3 pb-2 space-y-0.5" style={{ scrollbarWidth: 'none' }} aria-label="Main Navigation">
          {filtered.map(cat => {
            ...
            const subId = `subnav-${cat.title.replace(/\s+/g, '-').toLowerCase()}`;
